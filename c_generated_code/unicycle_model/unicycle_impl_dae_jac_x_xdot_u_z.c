...
/* unicycle_impl_dae_jac_x_xdot_u_z:(i0[3],i1[3],i2[2],i3[0],i4[],i5[0])->(o0[3x3,2nz],o1[3x3,3nz],o2[3x2,3nz],o3[3x0]) */
...
CASADI_SYMBOL_EXPORT casadi_int unicycle_impl_dae_jac_x_xdot_u_z_n_in(void) { return 6;}
...
CASADI_SYMBOL_EXPORT int unicycle_impl_dae_jac_x_xdot_u_z_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
